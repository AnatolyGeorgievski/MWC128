...
inline void xorshiftstar_hash ( const void * key, int len, uint32_t seed, void * out ) {
    *(uint64_t*)out = xorshiftstar_hash_64((const uint8_t*)key, len, seed);
}
extern "C" uint64_t xoroshiro_hash(const uint8_t *data, uint64_t len, uint64_t seed0);
extern "C" uint64_t mwc64_hash    (const uint8_t *data, uint64_t len, uint64_t seed0);
extern "C" uint64_t mwc64r2_hash  (const uint8_t *data, uint64_t len, uint64_t seed0);
extern "C" uint64_t xxh64_hash    (const uint8_t *data, uint64_t len, uint64_t seed0);
extern "C" uint64_t mwc128_hash    (const uint8_t *data, uint64_t len, uint64_t seed0);
extern "C" void     mwc128_128_hash(const uint8_t *data, uint64_t len, uint64_t seed0, uint64_t* result);
extern "C" void     mwc128_256_hash(const uint8_t *data, uint64_t len, uint64_t seed0, uint64_t* result);
inline void xoroshiro_test ( const void * key, int len, uint32_t seed, void * out ) {
    *(uint64_t*)out = xoroshiro_hash((const uint8_t*)key, len, seed);
}
inline void mwc64_test ( const void * key, int len, uint32_t seed, void * out ) {
    *(uint64_t*)out = mwc64_hash((const uint8_t*)key, len, seed);
}
inline void mwc128_test ( const void * key, int len, uint32_t seed, void * out ) {
    *(uint64_t*)out = mwc128_hash((const uint8_t*)key, len, seed);
}
inline void mwc128_128_test ( const void * key, int len, uint32_t seed, void * out ) {
    mwc128_128_hash((const uint8_t*)key, len, seed,(uint64_t*)out);
}
inline void mwc128_256_test ( const void * key, int len, uint32_t seed, void * out ) {
    mwc128_256_hash((const uint8_t*)key, len, seed,(uint64_t*)out);
}
inline void mwc64r2_test ( const void * key, int len, uint32_t seed, void * out ) {
    *(uint64_t*)out = mwc64r2_hash((const uint8_t*)key, len, seed);
}
inline void xxh64_test ( const void * key, int len, uint32_t seed, void * out ) {
    *(uint64_t*)out = xxh64_hash((const uint8_t*)key, len, seed);
}
//-----------------------------------------------------------------------------
