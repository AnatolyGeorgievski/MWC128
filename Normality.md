...
- [Критерий нормальности Колмогорова-Смирнова](#критерий-нормальности-колмогорова-смирнова)
  ...
  - [Рештчатая структура ГПСЧ](#рештчатая-структура-гпсч)
    - [Определения из теории решеток](#определения-из-теории-решеток)
...
### Определения из теории решеток

* Рештчатая структура. Аналогом является кристаллическая решетка, где переход между слоями выполняется методом трансляции или вращения системы координат. Набор линейно независимых векторов соответствующий трансляциям решетки составляет базис. Набор трансляций и вращений составляет группы - алгебру над операциями трансляции и матрицами вращения. 
...
Матрицу трансформации $A$ можно рассматривать, как композицию двух частей: матрица перестановок со свойством циркулянта и операция low-Runk скалярное произведеление векторов.
