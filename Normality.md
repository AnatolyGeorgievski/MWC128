...
Для генерации однородного распределения float U(0,1) на GPU мы рекомендуем использовать генераторы Xoroshiro64. Для генерации в формате double следует использовать генераторы 128 бит, такие как MWC128 и Xoroshiro128.
...
см. Провальный пример [теста линейности xoroshiro128+](https://prng.di.unimi.it/xoroshiro128+-lower32.c), то как можно использовать TestU01 с кастомным набором параметров.
