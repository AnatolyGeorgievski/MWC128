...
* [CRC64-hash](test/crc64_hash.c) Алгоритмы представлены с векторизацией и Folding x4 на операциях CLMUL - умножение без переносов, полиномиальное умножение в поле GF(2) для нескольких полиномов степени 64, 32. 
...
* [XXH64-hash 64-bit](test/xxh64.cpp) -- в алгоритм добавлен входной миксер `avalanche(seed)`
