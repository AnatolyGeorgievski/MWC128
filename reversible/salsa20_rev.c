...
Раунд Salsa можно представить как 
...
2. Действия c = f(a,b), не требуют обращения, оператор `^=` обратный сам себе.
3. Порядок действий меняется на обратный

Сборка и тестирование:
	$ gcc -O3 -march=native -o test salsa20_rev.c
	$ ./test
