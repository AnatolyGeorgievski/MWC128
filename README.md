...
Скажем так, в нашей _колоде_, как её не сдавай, будет определенное число козырных тузов, повторяющихся паттернов. Один из видов этих паттернов образуют степени двойки. 
На этом принципе можно реализовать общий статистический тест "Trump aces", дистанция между паттернами. 

Наличие _орбит_ и фиксированного числа козырных тузов - свойство всех линейных конгруэнтных генераторов (LCG), включая MWC. При выборе генератора эти свойства надо учитывать. Наличие тузов и период орбиты зависит от выбора параметров простого числа. Для MWC128 дистанция между паттернами должна быть существенно большая. 
