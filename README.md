...
* [Анализ производительности генераторов ГПСЧ](#)
* [Комбинированные MWC генераторы](#)
...
В данном проекте даются методы вычисления отступов основанные на модульной арифметике большой разрядности (multi-precision, см. [mp.c](mp.c)). 
