...
Если два разных зазора между степенями двойки, один зазор равен 1 (один шаг генератора), то для степени $2^{32}$, дистанция приблизительно равна $(P-15)/16$. 
...
На этом принципе можно реализовать общий тест "Trump aces". 

Наличие _орбит_ и фиксированного числа козырных тузов - свойство всех линейных конгруэнтных генераторов (LCG), включая MWC. При выборе генератора эти свойства надо иметь ввиду.
