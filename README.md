...
- [MWC128 - Multiply With Carry Рseudo-Random Number Generators  (PRNG)](#mwc128---multiply-with-carry-рseudo-random-number-generators--prng)
	...
	- [Период повтора и орбиты](#период-повтора-и-орбиты)
...
*gaps between powers of two* - это расстояние можно спрогнозировать. Может быть два варианта дистанций по количеству шагов генератора между степенями двойки.
...
Для исправления решетчатой структуры генератора можно использовать комбинацию генераторов с разным периодом, Combined-MWC. 
```math
